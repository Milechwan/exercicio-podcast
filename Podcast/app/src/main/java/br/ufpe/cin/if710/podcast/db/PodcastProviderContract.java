...
public class PodcastProviderContract {
    ...
    public static final String EPISODE_TITLE = "nome";
    public static final String EPISODE_DATE = "cpf";
    public static final String EPISODE_DESC = "email";
    public static final String EPISODE_LINK = "media";
    public static final String EPISODE_DOWNLOAD_LINK = "media";
    public static final String EPISODE_FILE_URI = "media";
